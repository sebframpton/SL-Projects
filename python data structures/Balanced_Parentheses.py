...
# Sample Output:
# False
# You can use a simple list for a stack. Use list.insert(0, item) to push on the stack, and list.pop(0)
#  to pop the top item. You can access the top element of the stack using list[0].
